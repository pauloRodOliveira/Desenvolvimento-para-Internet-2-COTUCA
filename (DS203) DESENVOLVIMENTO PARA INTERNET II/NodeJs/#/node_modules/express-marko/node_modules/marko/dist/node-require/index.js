...
function install(options) {
  ...
  ? options.require.extensions : require.extensions;

  var compilerOptions = Object.assign({ requireTemplates: true }, options.compilerOptions);
  ...
  requireExtensions[MARKO_EXTENSIONS] = requireExtensions[MARKO_EXTENSIONS] || (requireExtensions[MARKO_EXTENSIONS] = []);
